...
@Component({
  selector: 'app-apr-leaderboard',
  templateUrl: './apr-leaderboard.component.html',
})
export class AprLeaderboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.isLoading = true;
    this.tavisService?.getAprRecap().subscribe((data: any) => {
