...
const routes: Routes = [
  ...
  { path: 'oct-bonus', component: OctBonusComponent },
  { path: 'nov-bonus', component: NovBonusComponent },
  ...
  { path: 'oct-leaderboard', component: OctLeaderboardComponent },
  { path: 'nov-leaderboard', component: NovLeaderboardComponent },
  {
    path: 'player/:player',
